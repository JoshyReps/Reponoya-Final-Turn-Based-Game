...
public class Game {
            ...
            for(int[] area : locationArea) {
                ...
                if(Arrays.equals(area, player.playerPosition)){
                    ...
                    switch(Arrays.toString(player.playerPosition)) {
                        case "[3, 12]" -> encounter(150, " (Sky Island Boss)", 15, 5, 50);
                        case "[-3, -12]" -> encounter(50, " (Fish Island Boss)", 30, 15, 100);
                        case "[15, 15]" -> encounter(250, " (Wano Boss)", 25, 10, 150); 
                        case "[50, 50]" -> encounter(300, " (Grand Line Boss)", 30, 15, 250); 
                    }
    ...
    private String coordinateToLocation () {

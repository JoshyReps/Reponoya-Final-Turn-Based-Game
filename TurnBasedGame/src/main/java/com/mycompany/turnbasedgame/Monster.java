...
public class Monster extends Character {
    ...
    public void healingPassive(Character character, Character enemy) {
    ...
    // ===========================================================================================================
    private void parry (Character player){
        //  0 1 2 3
    ...
    // ===========================================================================================================
     ...
     public void unoReverseTechnique (Character character, Character enemy) {
    ...
    void actionInputSelection(Character enemy) {
        ...
        System.out.printf("%n%s is Analyzing their Next Brilliant Move!!%n".formatted(this.playerName)); //Thread.sleep(7000L);
                ...
                if(randomBotChoice.equals(randomBotChoice)) parry(enemy);
